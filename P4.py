# -*- coding: utf-8 -*-
"""
Created on Sun Nov 29 14:35:55 2020

@author: Jordileth Bonilla Segura 
"""

# Proyecto 4 IE-0405 Modelos probabilísticos de sistemas y señales
...
''' Para realizar el modulador correctamente, se separa en dos: 
    uno para coseno y uno para seno''' 
...
def modcoseno(bits, fc, mpp):
    ...
    for i, bit in enumerate(bits):
        if bit == 1:
            senal_Txcoseno[i*mpp : (i+1)*mpp] = portcoseno
...
def demodulador(senal_Rx, portadora, mpp):
    ...
    '''Un método demodulador de señales, bajo un esquema QPSK. 
    El criterio de demodulación se basa en decodificación por 
